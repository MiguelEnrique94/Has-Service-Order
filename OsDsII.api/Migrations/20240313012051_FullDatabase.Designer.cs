...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240313012051_FullDatabase")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 20, 50, 946, DateTimeKind.Unspecified).AddTicks(6449), new TimeSpan(0, -3, 0, 0, 0)));
            ...
            modelBuilder.Entity("OsDsII.api.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 20, 50, 946, DateTimeKind.Unspecified).AddTicks(1170), new TimeSpan(0, -3, 0, 0, 0)));
